...
- **Hausverwaltung (Miete + WEG):** KI-Posteingang für Mieteranfragen, Handwerker-Koordination (Verzeichnis pro Gewerk, Notdienst, Beauftragung im Vorgang), Mieter/Objekte/Einheiten, Mietverträge mit Konditionen (Kaltmiete, Vorauszahlungen, Kaution, auslaufende Verträge im Blick), Zählerstände mit Plausibilitätsprüfung — auch mobil am Smartphone erfassbar, **Nebenkostenabrechnung** (Umlageschlüssel je Kostenart, zeitanteilige centgenaue Verteilung bei Mieterwechsel, § 35a-Ausweis, Beleg-Foto mit KI-Vorschlag, prüffähiges Abrechnungs-PDF je Mieter als Entwurf), Verwalterverträge mit automatischer Pauschalen-Rechnung zum Stichtag, **WEG-Verwaltung** (Eigentümerversammlung mit Einladung/Frist nach § 24 WEG, Tagesordnung, Abstimmungen nach Köpfen oder Miteigentumsanteilen, fortlaufende Beschlusssammlung nach § 24 Abs. 7 WEG, Protokoll-PDF-Entwurf, Wirtschaftsplan mit Hausgeld-Vorschlag je Einheit nach MEA, monatliche Sollstellungen mit Zahlungs-Tracking), tenant-weites Dokumentenarchiv (Filter nach Objekt/Typ/Quelle/Zeitraum), Import aus dem Mietvertrag (OCR), Stapel-Import ganzer Bestände (deterministische CSV-Vorlagen), Spam-Filter, 14 Branchen-Vorlagen. Zubuchbar: **Bau-Angebote-Modul** für Verwalter mit eigenem Bau-/Handwerksbetrieb (Angebote mit Positionen, Artikelstamm per Baumarkt-/Großhandels-CSV, Kalkulation).
